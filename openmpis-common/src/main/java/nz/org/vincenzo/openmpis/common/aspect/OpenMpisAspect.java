...
public class OpenMpisAspect {
     ...
     */
    @Before("nz.org.vincenzo.openmpis.common.aspect.Pointcuts.allDAOMethods()")
     ...
     */
    @AfterThrowing(value = "nz.org.vincenzo.openmpis.common.aspect.Pointcuts.allDAOMethods()", throwing = "throwable")
     ...
     */
    @AfterReturning(value = "nz.org.vincenzo.openmpis.common.aspect.Pointcuts.allDAOMethods()", returning = "result")
     ...
     * @param joinPoint the {@link JoinPoint}
     */
    @Before("nz.org.vincenzo.openmpis.common.aspect.Pointcuts.allServiceMethods()")
     ...
     * @param throwable the {@link Throwable}
     */
    @AfterThrowing(value = "nz.org.vincenzo.openmpis.common.aspect.Pointcuts.allServiceMethods()", throwing =
            "throwable")
     ...
     * @param result    the returning result
     */
    @AfterReturning(value = "nz.org.vincenzo.openmpis.common.aspect.Pointcuts.allServiceMethods()", returning = "result")
