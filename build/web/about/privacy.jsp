...
<html:html xhtml="true">
    <head>
        ...
        <bean:message key="privacy.title"/>
        <html:base/>
    </head>
    <body>
        <tag:header/>
            ...
            <div id="content">
                <div id="contentitem">
                    ...
                    <h1></h1>
                        ...
                        At times, in connection with certain service offered through this site, you may be asked to
                        supply personal information such as name, email address, postal address, telephone number
                        and in the case of making online donations your credit/debit card details.
                        
                        How this information is used?

                        This Information will be used:

                            * to identify you enabling us to send out information or supply a service
                            * to process donations
                            * to increase our understanding of how this site is used.

                        We will ensure that all information collected is only used for the purpose for which it was requested, held securely and kept for so long as necessary for the purpose it was obtained.

                        * Cookies

                        To enable us to understand more about how our site is used we may send cookies to your PC. A cookie enables us to recognise whether you have used the site before. Cookies are specific to the server that created them and cannot be used to track your movements around the web. They do not personally identify users and credit/debit card details or passwords are not stored in them. If you do not want cookies to be stored on your PC you can change your browser to prevent it.

                        * Changes to Privacy Policy
                        If we change our online privacy policy in any way, we will post these changes on this page.

                        We do not share any personal information about visitors to this website except what they voluntarily choose to give us via email. We do not pass any personal data to outside organisations except with express consent.
