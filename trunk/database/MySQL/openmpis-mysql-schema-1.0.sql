...
CREATE INDEX openmpis_abductorIDX1 ON openmpis.abductor(id);
...
CREATE INDEX openmpis_logIDX1 ON openmpis.log(id);
...
CREATE INDEX openmpis_messageIDX1 ON openmpis.message(id);
...
CREATE INDEX openmpis_personIDX1 ON openmpis.person(id);
...
CREATE INDEX openmpis_relativeIDX1 ON openmpis.relative(id);
...
CREATE INDEX openmpis_reportIDX1 ON openmpis.report(id);
...
CREATE INDEX openmpis_userIDX1 ON openmpis.user(id);
