        ...
        <tag:header/>
            ...
            <div id="content">
                <div id="contentitem">
                    ...
                    <html:form styleId="userform" method="post" action="editUserBean" styleClass="adduserclass">
                        <p class="contentclass">
                            <label id="idlabel" class="labelclass" for="idfield"><bean:message key="user.label.id"/></label>
                            <html:text styleId="idfield" styleClass="inputclass" property="id" readonly="true" maxlength="6" value="${user.id}"/>
                        ...
                        <p class="contentclass">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <html:text styleId="usernamefield" styleClass="inputclass" property="username" maxlength="6" value="${user.username}" readonly="true"/>
                                </c:otherwise>
                                </c:choose>
                        ...
                        <c:if test="${user.id eq currentuser.id}">
                            <p class="contentclass">
                                ...
                                <html:password styleId="passwordfield" styleClass="inputclass" property="password" maxlength="10" value="" redisplay="false"/>
                                <html:errors property="password"/>
                            </p>
                            <p class="contentclass">
                                <label id="retypelabel" class="labelclass" for="retypefield"><bean:message key="user.label.retype"/></label>
                                <html:password styleId="passwordfield" styleClass="inputclass" property="retype" maxlength="10" value="" redisplay="false"/>
                            </p>
                        </c:if>
                        <p class="contentclass">
                        ...
                        <p class="contentclass">
                            ...
                            <html:text styleId="ipaddressfield" styleClass="inputclass" property="ipAddress" readonly="true" maxlength="30" value="${user.ipAddress}"/>
                        ...
                        <p class="contentclass">
                            ...
                            <html:text styleId="lastloginfield" styleClass="inputclass" property="lastLogin" readonly="true" maxlength="30" value="${user.lastLogin}"/>
                            <html:errors property="lastlogin"/>
                        </p>
                        <p class="contentclass">
                            <label id="datelabel" class="labelclass" for="datefield"><bean:message key="user.label.date"/></label>
                            <html:text styleId="datefield" styleClass="inputclass" property="date" readonly="true" maxlength="30" value="${user.date}"/>
                        ...
                        <p class="contentclass">
                            ...
                            <html:text styleId="creatoridfield" styleClass="inputclass" property="creatorId" readonly="true" maxlength="30" value="${user.creatorId}"/>
                        ...
                        <c:if test="${user.id eq currentuser.id}">
                            <p class="contentclass">
                                ...
                                <html:select property="question" value="${user.question}" styleId="questionfield" styleClass="selectclass">
                            ...
                            <p class="contentclass">
                                ...
                                <html:text styleId="answerfield" styleClass="inputclass" property="answer" size="37" maxlength="30" value="${user.answer}"/>
                        ...
                        <!-- cases encoded -->
                        <p class="contentclass">
                            <bean:message key="user.edit.buttons" arg0="${user.id}"/>
                        </p>
                    </html:form>
                </div>
            </div>
