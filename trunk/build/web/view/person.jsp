...
<html:html locale="true">
    <head>
        ...
        <meta name="keywords" content="genbank, genbankers, entry, dna, retrieval, system">
        <meta name="description" content="This is the Web page for the GenBank Entry Retrieval System.">
