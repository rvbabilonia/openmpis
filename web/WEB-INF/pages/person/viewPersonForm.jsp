            ...
            <div id="content">
                <div id="contentitem">
                    ...
                    <html:form method="post" action="viewUser" styleClass="adduserclass">
                        ...
                        <p class="contentclass">
                            <label id="birthdatelabel" class="labelclass" for="birthdatefield">
                                <bean:message key="label.birthdate"/>
                            </label>
                            <html:select styleId="monthfield" styleClass="monthselectclass" property="birthMonth">
                                <c:forEach begin="1" end="12" step="1" var="i" varStatus="monthCount">
                            ...
                            <html:select styleId="dayfield" styleClass="dayselectclass" property="birthDay">
                                <c:forEach begin="1" end="31" step="1" var="i" varStatus="monthCount">
                                    <html:option value="${i}" styleId="monthfield${i}" styleClass="dayoptionclass">${i}</html:option>
                                </c:forEach>
                            </html:select>
                            <html:select styleId="yearfield" styleClass="yearselectclass" property="birthYear">
                                <c:forEach begin="1949" end="1988" step="1" var="i" varStatus="monthCount">
